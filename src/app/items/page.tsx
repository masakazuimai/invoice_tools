      ...
      <Card className="p-0 overflow-hidden">
        <table className="w-full text-sm">
          <thead className="border-b bg-gray-50">
            <tr>
              <th className="px-6 py-3 text-left font-medium text-gray-500">品目名</th>
              <th className="px-6 py-3 text-right font-medium text-gray-500">単価</th>
              <th className="px-6 py-3 text-left font-medium text-gray-500">単位</th>
              <th className="px-6 py-3 text-left font-medium text-gray-500">税率</th>
